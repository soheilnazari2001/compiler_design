    ...
    def parse_program(self, parent):
        while True:
            ...
            if terminal in {"EOF"}:
                ...
                return None
            self.raise_unexpected_error("Program", terminal, parent=parent)
    ...
    def parse_declaration_list(self, parent):
        while True:
            ...
            if terminal in {"ID", ";", "NUM", "(", "{", "}", "break", "if", "for", "return", "+", "-", "EOF"}:
                ...
                self.epsilon(node)
                return node
            self.raise_unexpected_error("Declaration-list", terminal, parent=parent)
    ...
    def parse_declaration(self, parent):
        while True:
            ...
            if terminal in {"ID", ";", "NUM", "(", "int", "void", "{", "}", "break", "if", "for", "return", "+", "-", "EOF"}:
                ...
                return None
            self.raise_unexpected_error("Declaration", terminal, parent=parent)
    ...
    def parse_declaration_initial(self, parent):
        while True:
            ...
            if terminal in {";", "[", "(", ")", ","}:
                ...
                return None
            self.raise_unexpected_error("Declaration-initial", terminal, parent=parent)
    ...
    def parse_declaration_prime(self, parent):
        while True:
            ...
            if terminal in {"ID", ";", "NUM", "(", "int", "void", "{", "}", "break", "if", "for", "return", "+", "-", "EOF"}:
                ...
                return None
            self.raise_unexpected_error("Declaration-prime", terminal, parent=parent)
    ...
    def parse_var_declaration_prime(self, parent):
        while True:
            ...
            if terminal in {"ID", ";", "NUM", "(", "int", "void", "{", "}", "break", "if", "for", "return", "+", "-", "EOF"}:
                ...
                return None
            self.raise_unexpected_error("Var-declaration-prime", terminal, parent=parent)
    ...
    def parse_fun_declaration_prime(self, parent):
        while True:
            ...
            if terminal in {"ID", ";", "NUM", "(", "int", "void", "{", "}", "break", "if", "for", "return", "+", "-", "EOF"}:
                ...
                return None
            self.raise_unexpected_error("Fun-declaration-prime", terminal, parent=parent)
    ...
    def parse_type_specifier(self, parent):
        while True:
            ...
            if terminal in {"ID"}:
                ...
                return None
            self.raise_unexpected_error("Type-specifier", terminal, parent=parent)
    ...
    def parse_params(self, parent):
        while True:
            ...
            if terminal in {")"}:
                ...
                return None
            self.raise_unexpected_error("Params", terminal, parent=parent)
    ...
    def parse_param_list(self, parent):
        while True:
            ...
            if terminal in {")"}:
                ...
                self.epsilon(node)
                return node
            self.raise_unexpected_error("Param-list", terminal, parent=parent)
    ...
    def parse_param(self, parent):
        while True:
            ...
            if terminal in {")", ","}:
                ...
                return None
            self.raise_unexpected_error("Param", terminal, parent=parent)
    ...
    def parse_param_prime(self, parent):
        while True:
            ...
            if terminal in {")", ","}:
                ...
                self.epsilon(node)
                return node
            self.raise_unexpected_error("Param-prime", terminal, parent=parent)
    ...
    def parse_compound_stmt(self, parent):
        while True:
            ...
            if terminal in {"ID", ";", "NUM", "(", "int", "void", "{", "}", "break", "if", "endif", "else", "for", "return", "+", "-", "EOF"}:
                ...
                return None
            self.raise_unexpected_error("Compound-stmt", terminal, parent=parent)
    ...
    def parse_statement_list(self, parent):
        while True:
            ...
            if terminal in {"}"}:
                ...
                self.epsilon(node)
                return node
            self.raise_unexpected_error("Statement-list", terminal, parent=parent)
    ...
    def parse_statement(self, parent):
        while True:
            ...
            if terminal in {"ID", ";", "NUM", "(", "{", "}", "break", "if", "endif", "else", "for", "return", "+", "-"}:
                ...
                return None
            self.raise_unexpected_error("Statement", terminal, parent=parent)
    ...
    def parse_expression_stmt(self, parent):
        while True:
            ...
            if terminal in {"ID", ";", "NUM", "(", "{", "}", "break", "if", "endif", "else", "for", "return", "+", "-"}:
                ...
                return None
            self.raise_unexpected_error("Expression-stmt", terminal, parent=parent)
    ...
    def parse_selection_stmt(self, parent):
        while True:
            ...
            if terminal in {"ID", ";", "NUM", "(", "{", "}", "break", "if", "endif", "else", "for", "return", "+", "-"}:
                ...
                return None
            self.raise_unexpected_error("Selection-stmt", terminal, parent=parent)
    ...
    def parse_else_stmt(self, parent):
        while True:
            ...
            if terminal in {"ID", ";", "NUM", "(", "{", "}", "break", "if", "endif", "else", "for", "return", "+", "-"}:
                ...
                return None
            self.raise_unexpected_error("Else-stmt", terminal, parent=parent)
    ...
    def parse_iteration_stmt(self, parent):
        while True:
            ...
            if terminal in {"ID", ";", "NUM", "(", "{", "}", "break", "if", "endif", "else", "for", "return", "+", "-"}:
                ...
                return None
            self.raise_unexpected_error("Iteration-stmt", terminal, parent=parent)
    ...
    def parse_return_stmt(self, parent):
        while True:
            ...
            if terminal in {"ID", ";", "NUM", "(", "{", "}", "break", "if", "endif", "else", "for", "return", "+", "-"}:
                ...
                return None
            self.raise_unexpected_error("Return-stmt", terminal, parent=parent)
    ...
    def parse_return_stmt_prime(self, parent):
        while True:
            ...
            if terminal in {"ID", ";", "NUM", "(", "{", "}", "break", "if", "endif", "else", "for", "return", "+", "-"}:
                ...
                return None
            self.raise_unexpected_error("Return-stmt-prime", terminal, parent=parent)
    ...
    def parse_expression(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ","}:
                ...
                return None
            self.raise_unexpected_error("Expression", terminal, parent=parent)
    ...
    def parse_b(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ","}:
                ...
                return None
            self.raise_unexpected_error("B", terminal, parent=parent)
    ...
    def parse_h(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ","}:
                ...
                return None
            self.raise_unexpected_error("H", terminal, parent=parent)
    ...
    def parse_simple_expression_zegond(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ","}:
                ...
                return None
            self.raise_unexpected_error("Simple-expression-zegond", terminal, parent=parent)
    ...
    def parse_simple_expression_prime(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ","}:
                ...
                return None
            self.raise_unexpected_error("Simple-expression-prime", terminal, parent=parent)
    ...
    def parse_c(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ","}:
                ...
                self.epsilon(node)
                return node
            self.raise_unexpected_error("C", terminal, parent=parent)
    ...
    def parse_relop(self, parent):
        while True:
            ...
            if terminal in {"ID", "NUM", "(", "+", "-"}:
                ...
                return None
            self.raise_unexpected_error("Relop", terminal, parent=parent)
    ...
    def parse_additive_expression(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ","}:
                ...
                return None
            self.raise_unexpected_error("Additive-expression", terminal, parent=parent)
    ...
    def parse_additive_expression_prime(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ",", "<", "=="}:
                ...
                return None
            self.raise_unexpected_error("Additive-expression-prime", terminal, parent=parent)
    ...
    def parse_additive_expression_zegond(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ",", "<", "=="}:
                ...
                return None
            self.raise_unexpected_error("Additive-expression-zegond", terminal, parent=parent)
    ...
    def parse_d(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ",", "<", "=="}:
                ...
                self.epsilon(node)
                return node
            self.raise_unexpected_error("D", terminal, parent=parent)
    ...
    def parse_addop(self, parent):
        while True:
            ...
            if terminal in {"ID", "NUM", "(", "+", "-"}:
                ...
                return None
            self.raise_unexpected_error("Addop", terminal, parent=parent)
    ...
    def parse_term(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ",", "<", "==", "+", "-"}:
                ...
                return None
            self.raise_unexpected_error("Term", terminal, parent=parent)
    ...
    def parse_term_prime(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ",", "<", "==", "+", "-"}:
                ...
                return None
            self.raise_unexpected_error("Term-prime", terminal, parent=parent)
    ...
    def parse_term_zegond(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ",", "<", "==", "+", "-"}:
                ...
                return None
            self.raise_unexpected_error("Term-zegond", terminal, parent=parent)
    ...
    def parse_g(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ",", "<", "==", "+", "-"}:
                ...
                self.epsilon(node)
                return node
            self.raise_unexpected_error("G", terminal, parent=parent)
    ...
    def parse_signed_factor(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ",", "<", "==", "+", "-", "*"}:
                ...
                return None
            self.raise_unexpected_error("Signed-factor", terminal, parent=parent)
    ...
    def parse_signed_factor_prime(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ",", "<", "==", "+", "-", "*"}:
                ...
                return None
            self.raise_unexpected_error("Signed-factor-prime", terminal, parent=parent)
    ...
    def parse_signed_factor_zegond(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ",", "<", "==", "+", "-", "*"}:
                ...
                return None
            self.raise_unexpected_error("Signed-factor-zegond", terminal, parent=parent)
    ...
    def parse_factor(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ",", "<", "==", "+", "-", "*"}:
                ...
                return None
            self.raise_unexpected_error("Factor", terminal, parent=parent)
    ...
    def parse_var_call_prime(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ",", "<", "==", "+", "-", "*"}:
                ...
                return None
            self.raise_unexpected_error("Var-call-prime", terminal, parent=parent)
    ...
    def parse_var_prime(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ",", "<", "==", "+", "-", "*"}:
                ...
                self.epsilon(node)
                return node
            self.raise_unexpected_error("Var-prime", terminal, parent=parent)
    ...
    def parse_factor_prime(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ",", "<", "==", "+", "-", "*"}:
                ...
                self.epsilon(node)
                return node
            self.raise_unexpected_error("Factor-prime", terminal, parent=parent)
    ...
    def parse_factor_zegond(self, parent):
        while True:
            ...
            if terminal in {";", "]", ")", ",", "<", "==", "+", "-", "*"}:
                ...
                return None
            self.raise_unexpected_error("Factor-zegond", terminal, parent=parent)
    ...
    def parse_args(self, parent):
        while True:
            ...
            if terminal in {")"}:
                ...
                self.epsilon(node)
                return node
            self.raise_unexpected_error("Args", terminal, parent=parent)
    ...
    def parse_arg_list(self, parent):
        while True:
            ...
            if terminal in {")"}:
                ...
                return None
            self.raise_unexpected_error("Arg-list", terminal, parent=parent)
    ...
    def parse_arg_list_prime(self, parent):
        while True:
            ...
            if terminal in {")"}:
                ...
                self.epsilon(node)
                return node
            self.raise_unexpected_error("Arg-list-prime", terminal, parent=parent)
